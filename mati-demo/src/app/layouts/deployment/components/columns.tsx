...
export const columns: ColumnDef<EngagementRecord>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => <div className="text-sm">{row.getValue("plots")}</div>,
    },
    {
        accessorKey: "area",
        size: 80,
        ...
        cell: ({ row }) => <div className="text-sm">{row.getValue("area")}</div>,
    },
    {
        accessorKey: "calArea",
        size: 100,
        header: ({ column }) => (
            <DataTableColumnHeader column={column} title="Cal. Area" />
        ),
        cell: ({ row }) => <div className="text-sm">{row.getValue("calArea")}</div>,
    },
    {
        accessorKey: "azs",
        size: 100,
    ...
    },
    {
        ...
        cell: ({ row }) => <div className="text-sm">{row.getValue("deployed")}</div>,
    },
    {
